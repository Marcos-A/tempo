...
export PREVIEW_DATA_DIR="${PREVIEW_DATA_DIR:-/srv/data/curriculum-planner-preview}"
export PREVIEW_ENV_FILE="${PREVIEW_ENV_FILE:-/srv/config/curriculum-planner/.env.preview}"
